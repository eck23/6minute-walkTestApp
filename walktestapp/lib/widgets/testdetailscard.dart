...
class TestDetailsCard extends StatelessWidget {
  ...
  TestDetailsCard({required this.testDetails,required this.number,required this.testid,required this.name,required this.context,required this.function}); 
  ...
  void showDetailedViewPortrait(){
    showDialog(context: context, builder:(ctx){
      return  AlertDialog(
          ...
          contentPadding: EdgeInsets.symmetric(horizontal: 7,vertical: 20),
          content: Container(
            height: 500.h,
            width: 500.h,
            ...
            child: ListView(
              ...
              children:[ 
                Text("Test Details",style: TextStyle(fontSize: 20.sp),),
                Padding(
                  padding:  EdgeInsets.only(top:20.h,bottom: 20.h),
                  child: Text("Test Date : ${testDetails.date} ",style: TextStyle(fontSize: 12.sp),),
                ),
                DataTable( 
             ...
             if(testDetails.Stopped_before==true)Padding(
               padding: EdgeInsets.only(top: 20.h),
